  ...
  return (
    <div className='relative inline-block'>
      <button
        ...
        className='max-w-[12rem] truncate text-light bg-transparent hover:bg-secondary-gray/50 font-medium h-10 md:px-4 md:py-2 px-2 border rounded transition text-xs sm:text-base'
      >
